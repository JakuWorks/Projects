...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Jakub\!KUBA\Projects\Projects\Small\(W.I.P) Self-HostedSimpleDiscordBot (.py)\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Jakub\!KUBA\Projects\Projects\Small\(W.I.P) Self-HostedSimpleDiscordBot (.py)\venv\Scripts\deactivate.nu'
